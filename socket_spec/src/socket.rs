...
/// string. Use [`ActionHandle::new(plugin, prop)`] to convert hashes to web, and
/// [`handle.get_hashes()`] converts them back.
#[derive(Debug,Clone,Deserialize,Serialize,PartialEq)]
#[serde(transparent)]
...
/// When authenticating as a dashboard this struct is passed into auth_dashboard
/// 
/// The token is generated by DataRace, you will receive a require_reload if it is not correct.
/// It is generated from the had of the dashboard using Highway Hash, with the secret being
/// randomized each start of DataRace, meaning changes on the dashboard and restart will trigger a
/// require reload.
#[derive(Debug, Clone, Serialize, Deserialize)]
